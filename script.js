// ===== Scroll effects + botão topo + menu mobile (vanilla JS) =====
...
document.addEventListener("click", function (e) {
  ...
  if (!langBox.contains(e.target)) dropdown.classList.remove("show");
});
...
const translations = {
  pt: {
    ...
    projects: {
      ...
      subtitle: "Portfólio",
      bikcraftAlt:
        "Site completo criado para empresa de bicicletas, com páginas de preços e informações dos produtos.",
      bikcraftText:
        "Site completo criado para empresa de bicicletas, com páginas de preços e informações dos produtos.",
      drAlt:
        "Site criado exclusivamente para dentista, totalmente responsivo e com atendimento via API Whatsapp.",
      drText:
        "Site criado exclusivamente para dentista, totalmente responsivo e com atendimento via API Whatsapp.",
      gameAlt:
        "Um jogo que utiliza uma API de reconhecimento de voz para encontrar o valor correto.",
      gameTitle: "Game",
      gameText:
        "Um jogo que faz a utilização de uma API de reconhecimento de voz para encontrar o valor correto.",
      frutoAlt:
        "Um projeto realizado em Bootstrap utilizando um layout de receitas responsivo.",
      frutoText:
        "Um projeto realizado em Bootstrap utilizando um layout de receitas responsivo.",
      organoAlt:
        "Site criado utilizando a biblioteca React, com um formulário dinâmico para implementação de desenvolvedores.",
      organoTitle: "Site Organo",
      organoText:
        "Site criado utilizando a biblioteca React, onde foi criado um formulário dinâmico para implementação de desenvolvedores.",
      imobAlt:
        "Um site pensado para uma Imobiliária, utilizando o framework Bootstrap para o seu desenvolvimento.",
      imobTitle: "Imobiliária",
      imobText:
        "Um site pensado para uma Imobiliária, utilizando o framework Bootstrap para o seu desenvolvimento.",
      aluraAlt:
        "Um site da Alura onde são divulgados livros e conteúdos online para desenvolvimento de sistemas.",
      aluraTitle: "Alura Books",
      aluraText:
        "Um site da Alura onde são divulgados livros e conteúdos online para desenvolvimento de sistemas.",
      devAlt:
        "Sites que estão sendo desenvolvidos e logo mais estarão inclusos no Portfólio.",
    ...
    contact: {
      ...
      leftText:
        "Caso tenha se interessado e queira entrar em contato, encontro-me à disposição para esclarecer quaisquer dúvidas.",
      nameLabel: "Nome",
      phoneLabel: "Telefone",
      emailLabel: "Email",
      formTitle: "Mensagem",
  ...
  en: {
    ...
    services: {
      ...
      reactNative:
        "React Native is a JavaScript library created by Facebook. It is used to develop native apps for Android and iOS.",
      bootstrap:
        "Bootstrap is an open-source web framework for building front-end components and interfaces.",
      powerAutomate:
        "Power Automate is a Microsoft platform that allows automating tasks and business processes using intuitive flows and triggers.",
      powerApps:
        "Power Apps is a Microsoft platform for creating custom business applications connected to data sources like SharePoint, Excel, and other services.",
      sharepoint:
        "SharePoint is a collaborative platform by Microsoft used to create sites that store, organize and share documents securely while supporting team productivity.",
    },
    ...
    skills: {
      ...
      leftText:
        "I am currently looking for new opportunities to improve my knowledge even further. Most of my experience was acquired through classroom learning and online education platforms, where I completed various challenges that helped me gain solid knowledge for entering the developer field.",
    },
    ...
    projects: {
      ...
      subtitle: "Portfolio",
      bikcraftAlt:
        "Full website created for a bicycle company, with pricing pages and product information.",
      bikcraftText:
        "Full website created for a bicycle company, including pricing pages and product details.",
      drAlt:
        "Website created exclusively for a dentist, fully responsive with WhatsApp API support.",
      drText:
        "Exclusive website for a dentist, fully responsive and connected to a WhatsApp API.",
      gameAlt:
        "A game that uses a voice recognition API to find the correct number.",
      gameTitle: "Voice Game",
      gameText:
        "A game that uses a voice recognition API to guess the correct number.",
      ...
      organoAlt:
        "Website created using React, featuring a dynamic form for developer registration.",
      organoTitle: "Organo Website",
      organoText:
        "Website created using the React library, featuring a dynamic form for developer registration.",
      imobAlt: "A real estate website built using Bootstrap.",
      imobTitle: "Real Estate",
      imobText:
        "A real estate website designed using the Bootstrap framework.",
      aluraAlt:
        "An Alura website showcasing books and online development content.",
      aluraTitle: "Alura Books",
      aluraText:
        "An Alura website presenting books and online content for system development.",
      devAlt:
        "Websites currently in development that will soon be included in the portfolio.",
      devTitle: "In Development",
      devText:
        "Websites currently being developed and soon to be added to the portfolio.",
    },
    ...
    contact: {
      ...
      leftText:
        "If you are interested and would like to get in touch, I am available to answer any questions.",
      nameLabel: "Name",
      phoneLabel: "Phone",
      emailLabel: "Email",
      formTitle: "Message",
...
function applyI18n(lang) {
  ...
  document.querySelectorAll("[data-i18n]").forEach((el) => {
    ...
    const value = key
      .split(".")
      .reduce((acc, k) => (acc && acc[k] != null ? acc[k] : null), t);
...
// ===== Auto-scroll do carrossel (suave de verdade) =====
function easeInOutCubic(t) {
  return t < 0.5 ? 4 * t * t * t : 1 - Math.pow(-2 * t + 2, 3) / 2;
}

function animateScrollLeft(el, to, duration = 650) {
...
function getStep(carousel) {
  ...
  // largura real do card + gap do flex (20px no seu CSS)
  return card.getBoundingClientRect().width + 20;
}

function smoothNext(carousel) {
  ...
  // desliga snap durante a animação (evita “puxão”)
  const prevSnap = carousel.style.scrollSnapType;
  carousel.style.scrollSnapType = "none";

  animateScrollLeft(carousel, target, 700);

  // reativa snap depois
  setTimeout(() => {
    carousel.style.scrollSnapType = prevSnap || "x proximity";
  }, 750);
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // ===== Auto-scroll do carrossel (suave) =====
  const carousel = document.querySelector(".projetos .carousel");
  if (carousel) {
    let timer = setInterval(() => smoothNext(carousel), 3000);

    carousel.addEventListener("mouseenter", () => clearInterval(timer));
    carousel.addEventListener("mouseleave", () => {
      timer = setInterval(() => smoothNext(carousel), 3000);
    });
  }
});